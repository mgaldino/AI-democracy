...
2. *Political paralysis.* Workers moving toward $R$ makes legislative bargaining over emergency spending harder. The non-exposed majority (who must approve taxation, per Appendix A) faces a more polarized environment.
