...
| D1-D3 | Multi-state equilibrium (state-specific protest, prior concentration) | Escrito, Appendix B, verificado analítica + numericamente (5/5 PASS) |
| Rk_cred | Credible commitment (D×R) | Escrito, Appendix B |

**Parâmetro atualizado**: π̄_A^fall = 0.06 (era 0.05). Margem R×A t=1: 0.009.
